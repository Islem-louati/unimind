...
final class EvenementCrudController extends AbstractController
{
    ...
    public function index(Request $request, EvenementRepository $repository): Response
    {
        ...
        return $this->render('evenement/responsable/evenement_index.html.twig', [
    ...
    {
        return $this->render('evenement/responsable/evenement_show.html.twig', [
            'evenement' => $evenement,
        ]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $em): Response
    {
        ...
        return $this->render('evenement/responsable/evenement_form.html.twig', [
            'evenement' => $evenement,
            'form' => $form,
            'is_edit' => false,
        ]);
