...
class EvenementSponsorRepository extends ServiceEntityRepository
{
    ...
    /**
     * Recherche et tri des contributions Événement–Sponsor (back office).
     * Recherche sur titre événement ou nom sponsor.
     *
     * @param string $q    Mot-clé
     * @param string $sort Champ : dateContribution, montantContribution, statut, typeContribution, evenement_titre, sponsor_nom
