...
class SponsorRepository extends ServiceEntityRepository
{
    ...
    /**
     * Recherche et tri des sponsors (back office).
     *
     * @param string $q    Mot-clé (nom, email, domaine)
     * @param string $sort Champ : nomSponsor, typeSponsor, emailContact, statut
    ...
    /**
     * Retourne les sponsors qui n'ont aucune contribution (EvenementSponsor).
     *
     * @return Sponsor[]
     */
