...
class Traitement
{
    ...
    #[ORM\JoinColumn(name: 'psychologue_id', referencedColumnName: 'user_id', nullable: true)]
    ...
    {
        // Convertir null en 0 ou garder null selon la logique métier
        $this->duree_jours = $duree_jours ?? 0;
        return $this;
    }
