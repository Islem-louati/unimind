...
class SuiviTraitement
{
    ...
    #[ORM\Column(name: 'observations', type: 'text', length: 1000, nullable: false)]
    #[Groups(['suivi:read', 'suivi:write'])]
    #[Assert\NotBlank(message: 'Les observations sont obligatoires', groups: ['etudiant'])]
    #[Assert\Length(
        min: 10,
        max: 1000,
    ...
    #[ORM\Column(name: 'observationsPsy', type: 'text', length: 1000, nullable: false)]
    #[Groups(['suivi:read', 'suivi:write'])]
    #[Assert\NotBlank(message: 'Les observations du psychologue sont obligatoires', groups: ['psychologue'])]
    #[Assert\Length(
        min: 10,
        max: 1000,
    ...
    #[Vich\UploadableField(mapping: 'suivi_documents', fileNameProperty: 'documentName', size: 'documentSize', mimeType: 'documentMimeType', originalName: 'documentOriginalName')]
    ...
    public function setDocumentFile(?File $documentFile = null): void
    {
        ...
        if (null !== $documentFile) {
            ...
            $this->documentUpdatedAt = new \DateTimeImmutable();
        }
    }

    public function getDocumentUpdatedAt(): ?\DateTimeImmutable
    {
        return $this->documentUpdatedAt;
    }

    public function setDocumentUpdatedAt(?\DateTimeImmutable $documentUpdatedAt): void
    {
